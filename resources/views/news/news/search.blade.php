                                ...
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        ...
                                        <div class="entry-meta">
                                            <span><i class="far fa-calendar-alt"></i>{{ date_format($new->updated_at,'M d, y') }}June 29, 2018</span>
...
<title>Du lịch Lý Sơn giá rẻ</title>
    ...
    <meta property="og:url" itemprop="url" content="{{ route('news.news.search') }}">
